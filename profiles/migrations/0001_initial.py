# Generated by Django 2.2.7 on 2020-01-21 10:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=255, null=True)),
                ('requirements', models.ManyToManyField(to='profiles.Requirement')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=255, null=True)),
                ('title', models.CharField(max_length=255)),
                ('requirement_groups', models.ManyToManyField(to='profiles.RequirementGroup')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('images', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.jsonb.JSONField(), blank=True, null=True, size=None)),
                ('unit_code', models.CharField(max_length=5)),
                ('unit_name', models.CharField(max_length=50)),
                ('value_amount', models.DecimalField(decimal_places=2, max_digits=10)),
                ('value_currency', models.CharField(choices=[('active', 'Active'), ('draft', 'Draft'), ('hidden', 'Hidden')], default='UAH', max_length=3)),
                ('value_value_added_tax_included', models.BooleanField(blank=True, default=True, null=True)),
                ('additional_classification', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.jsonb.JSONField(), blank=True, null=True, size=None)),
